...
//    private RedisCache redisCache;
    ...
    public LoginUser getLoginUser(HttpServletRequest request)
    {
        ...
        if (StringUtils.isNotEmpty(token))
        {
            try
            {
                ...
                LoginUser user = GuavaCommonLocalCache.getCacheObject(GuavaCommonLocalCache.KEY_LOGIN_TOKEN, userKey);
                return user;
            }
            catch (Exception e)
            {
    ...
    public void delLoginUser(String token)
    {
        if (StringUtils.isNotEmpty(token))
        {
            ...
            GuavaCommonLocalCache.deleteObject(GuavaCommonLocalCache.KEY_LOGIN_TOKEN, userKey);
        }
    }
    ...
    public void refreshToken(LoginUser loginUser)
    {
        ...
        GuavaCommonLocalCache.setCacheObject(GuavaCommonLocalCache.KEY_LOGIN_TOKEN, userKey, loginUser);
    }
